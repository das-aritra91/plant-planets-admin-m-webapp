...
import { animationOne } from '../../Animations/Page-Transition-animation';
...
export default function ManageTreeTypes(){
...
function Functionality(){
  return(<div>ManageTreeTypes page</div>)
}